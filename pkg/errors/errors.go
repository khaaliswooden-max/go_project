...
func ErrorCode(err error) string {
	...
	case err == nil:
		return ""
	case Is(err, ErrInvalidRequest), Is(err, ErrInvalidJSON):
		return CodeInvalidRequest
	case Is(err, ErrModelNotFound), Is(err, ErrModelNotLoaded):
		return CodeModelNotFound
	case Is(err, ErrOllamaUnavailable):
		return CodeOllamaUnavailable
	case Is(err, ErrRequestTimeout), Is(err, ErrOllamaTimeout), Is(err, ErrToolTimeout):
		return CodeTimeout
	case Is(err, ErrToolNotFound), Is(err, ErrToolExecFailed):
...
func IsRetryable(err error) bool {
	...
	return Is(err, ErrOllamaUnavailable) ||
		Is(err, ErrOllamaTimeout) ||
		Is(err, ErrStreamingError)
}
...
func IsClientError(err error) bool {
	...
	return Is(err, ErrInvalidRequest) ||
		Is(err, ErrInvalidJSON) ||
		Is(err, ErrModelNotFound) ||
		Is(err, ErrRequestCanceled)
}
